...
Cluster = function(args) {
  ...
  if (args) {
    if (args.clusterMemberIndexList !== undefined) {
      this.clusterMemberIndexList = args.clusterMemberIndexList;
    }
    if (args.confidenceList !== undefined) {
      this.confidenceList = args.confidenceList;
    }
    if (args.childIndexList !== undefined) {
      this.childIndexList = args.childIndexList;
    }
  }
};
Cluster.prototype = {};
...
Clustering = function(args) {
  ...
  if (args) {
    ...
    if (args.clusterMemberList !== undefined) {
      this.clusterMemberList = args.clusterMemberList;
    }
    if (args.clusterList !== undefined) {
      this.clusterList = args.clusterList;
    }
    if (args.rootClusterIndexList !== undefined) {
      this.rootClusterIndexList = args.rootClusterIndexList;
    }
  }
};
...
Communication = function(args) {
  ...
  if (args) {
    ...
    if (args.communicationMetadata !== undefined) {
      this.communicationMetadata = args.communicationMetadata;
    }
  }
};
...
CommunicationSet = function(args) {
  ...
  if (args) {
    if (args.communicationIdList !== undefined) {
      this.communicationIdList = args.communicationIdList;
    }
    if (args.corpus !== undefined) {
      this.corpus = args.corpus;
    }
    if (args.entityMentionClusterList !== undefined) {
      this.entityMentionClusterList = args.entityMentionClusterList;
    }
    if (args.entityClusterList !== undefined) {
      this.entityClusterList = args.entityClusterList;
    }
    if (args.situationMentionClusterList !== undefined) {
      this.situationMentionClusterList = args.situationMentionClusterList;
    }
    if (args.situationClusterList !== undefined) {
      this.situationClusterList = args.situationClusterList;
    }
  }
};
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i63 = 0; _i63 < _size58; ++_i63)
        {
          ...
          elem64 = new UUID();
          elem64.read(input);
          this.communicationIdList.push(elem64);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i70 = 0; _i70 < _size65; ++_i70)
        {
          ...
          elem71.read(input);
          this.entityMentionClusterList.push(elem71);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem78 = null;
          elem78 = new Clustering();
          elem78.read(input);
          this.entityClusterList.push(elem78);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem85 = null;
          elem85 = new Clustering();
          elem85.read(input);
          this.situationMentionClusterList.push(elem85);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem92 = null;
          elem92 = new Clustering();
          elem92.read(input);
          this.situationClusterList.push(elem92);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
CommunicationSet.prototype.write = function(output) {
  ...
  if (this.communicationIdList !== null && this.communicationIdList !== undefined) {
    ...
    for (var iter93 in this.communicationIdList)
    {
      if (this.communicationIdList.hasOwnProperty(iter93))
      {
        iter93 = this.communicationIdList[iter93];
        iter93.write(output);
      }
    }
    output.writeListEnd();
  ...
  if (this.entityMentionClusterList !== null && this.entityMentionClusterList !== undefined) {
    ...
    for (var iter94 in this.entityMentionClusterList)
    {
      if (this.entityMentionClusterList.hasOwnProperty(iter94))
      {
        iter94 = this.entityMentionClusterList[iter94];
        iter94.write(output);
      }
    }
    output.writeListEnd();
  ...
  if (this.entityClusterList !== null && this.entityClusterList !== undefined) {
    ...
    for (var iter95 in this.entityClusterList)
    {
      if (this.entityClusterList.hasOwnProperty(iter95))
      {
        iter95 = this.entityClusterList[iter95];
        iter95.write(output);
      }
    }
    output.writeListEnd();
  ...
  if (this.situationMentionClusterList !== null && this.situationMentionClusterList !== undefined) {
    ...
    for (var iter96 in this.situationMentionClusterList)
    {
      if (this.situationMentionClusterList.hasOwnProperty(iter96))
      {
        iter96 = this.situationMentionClusterList[iter96];
        iter96.write(output);
      }
    }
    output.writeListEnd();
  ...
  if (this.situationClusterList !== null && this.situationClusterList !== undefined) {
    ...
    for (var iter97 in this.situationClusterList)
    {
      if (this.situationClusterList.hasOwnProperty(iter97))
      {
        iter97 = this.situationClusterList[iter97];
        iter97.write(output);
      }
    }
    output.writeListEnd();
...
EntitySet = function(args) {
  ...
  if (args) {
    ...
    if (args.linkingList !== undefined) {
      this.linkingList = args.linkingList;
    }
  }
};
EntitySet.prototype = {};
...
EntityMention = function(args) {
  ...
  if (args) {
    ...
    if (args.childMentionIdList !== undefined) {
      this.childMentionIdList = args.childMentionIdList;
    }
  }
};
...
Link = function(args) {
  ...
  if (args) {
    ...
    if (args.linkTargetList !== undefined) {
      this.linkTargetList = args.linkTargetList;
    } else {
